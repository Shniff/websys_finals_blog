...
<?php
    if (isset($_SESSION['success'])) {
        echo "<div class='success-message' id='success-message'>" . htmlspecialchars($_SESSION['success']) . "</div>";
        unset($_SESSION['success']);
    }
    if (isset($_SESSION['error'])) {
        echo "<div class='error-message' id='error-message'>" . htmlspecialchars($_SESSION['error']) . "</div>";
                ...
                ?>
                                ...
                                <div id="post-<?php echo $post['post_id']; ?>" class="post">
                                    ...
                                    <p style="font-size: 0.85em; color: white;">
                                        Posted by <strong style="font-size: 0.85em; color: white;"><?php echo htmlspecialchars($post['username']); ?></strong>
